...
Instead of comparing their performance empirical, in our series of blog posts, we will be comparing them at a theoretical level. In the next post, we will draw out an explicit connection between a simplified version of PINN - a single layer perceptron, and traditional finite element methods.
